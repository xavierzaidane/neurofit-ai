        ...
        <div className="space-y-8">
          ...
          <div className="relative backdrop-blur-sm border border-border p-6">
            ...
            <div className="flex flex-wrap gap-2">
              {allPlans.map((plan) => (
                <div key={plan._id} className="flex items-center gap-2">
                  ...
                  <Button
                    variant="ghost"
                    size="icon"
                    className="h-8 w-8 border border-cyber-blue hover:bg-cyber-blue-dark hover:text-cyber-accent transition-all duration-200"
                    style={{
              ...
              {/* ✅ Render ConfirmDeleteDialog only once, outside the loop */}
              <ConfirmDeleteDialog
